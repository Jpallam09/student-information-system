...
$task_title = 'Activity Submission';
...
<div class="container">
    ...
    <div class="right-panel">
        ...
        <h1>Submit<br>Activity<br>for<br><strong><?= htmlspecialchars($subject_name) ?></strong></h1>
    </div>
    ...
    <div class="left-panel">
        ...
        <h2><?= $task_title ?></h2>
        <p>Create and submit activities for <strong><?= htmlspecialchars($subject_name) ?></strong></p>
        ...
        <form method="POST" enctype="multipart/form-data" class="register-form">
            ...
            <fieldset>
                <legend><i class="fas fa-file-alt"></i> Activity Details</legend>
